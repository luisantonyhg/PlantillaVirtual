    ...
    <article>
        ...
        <section class="section-small-padding background-white text-center">
            <div class="line">
                ...
                <h2 class="text-dark text-size-50 text-m-size-40">We are here for you <b class="text-primary">24/7</b>
                </h2>
            </div>
        </section>
                    ...
                    <div class="margin2x">
                        ...
                        <div class="l-12 xl-6">
                            ...
                            <div class="margin-left-60">
                                ...
                                <p>Hendrerit in vulputate duis autem vel eum iriure dolor in velit esse molestie
                                    consequat, vel illum dolore nulla facilisis</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section background-dark">
            <div class="s-12 m-12 l-4 center">
                ...
                <form class="customform text-white" method="post" enctype="multipart/form-data">
                    ...
                    <div class="line">
                        <div class="s-12">
                            <input name="subject" class="required subject" placeholder="Subject" title="Subject"
                                type="text" />
                        </div>
                        <div class="s-12">
                        ...
                        <div class="s-12"><button class="button border-radius text-white background-primary"
