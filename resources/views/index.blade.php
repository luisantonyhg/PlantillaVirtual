...
<main role="main">
    <!-- Header -->
    <header class="section-top-padding background-image text-center" style="background-image:url({{asset('assets/img/img-05.jpg')}})">
        <h1
        ...
        <p class="text-white">Duis autem vel eum iriure dolor in hendrerit in vulputate velit<br> esse molestie
        ...
        <!-- Image -->
        <img class="margin-top-20 center" src="{{asset('assets/img/app.png')}}" alt="">

        <!-- dark full width arrow object -->
        <img class="arrow-object" src="{{asset('assets/img/arrow-object-dark.svg')}}" alt="">
    </header>
            ...
            <div class="m-10 l-6 xl-4 center">
                <div class="margin">
                    <a class="s-12 m-6 margin-s-bottom" href="/">
                        <img class="full-img right" src="{{asset('assets/img/google-play.svg')}}" alt="">
                    </a>
                    <a class="s-12 m-6" href="/">
                        <img class="full-img" src="{{asset('assets/img/app-store.svg')}}" alt="">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="line">
            <div class="margin2x">
                ...
                <div class="s-12 m-6 l-4 margin-bottom-60">
                    ...
                    <div class="margin-left-60">
                        <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Many Reusable
                            Elements</h3>
                        <p>Hendrerit in vulputate duis autem vel eum iriure dolor in velit esse molestie consequat,
                            vel illum dolore nulla facilisis</p>
                        <a class="text-more-info text-primary" href="/">Read more</a>
            ...
            <div class="margin">
                ...
                <div class="s-12 m-12 l-4">
                    <div class="carousel-default owl-carousel carousel-hide-arrows margin-m-top-bottom-50">
                        <div class="item">
                            <img src="{{asset('assets/img/responsive-01.png')}}" />
                        </div>
                        <div class="item">
                            <img src="{{asset('assets/img/responsive-02.png')}}" />
                        </div>
                        <div class="item">
                            <img src="{{asset('assets/img/responsive-03.png')}}" />
                        </div>
                        <div class="item">
                            <img src="{{asset('assets/img/responsive-04.png')}}" />
                        </div>
                    </div>
                </div>
    ...
    <section class="background-primary full-width">
        <div class="m-12 l-6 xl-5 xxl-4">
            <img class="full-img" src="{{asset('assets/img/img-02.jpg')}}" />
        </div>
        <div class="m-12 l-6 xl-7 xxl-8">
            <div class="l-12 xl-11 xxl-8 padding-2x">
                ...
                <img class="margin-left-20 margin-top-30 margin-bottom-60"
                    src="{{asset('assets/img/start-your-business.svg')}}" alt="">
            </div>
        </div>
    </section>
    ...
    <section class="section-small-padding background-grey">
        <div class="margin2x">
            <div class="m-6 l-1">
                <img class="margin-bottom" src="{{asset('assets/img/logo-1.png')}}" />
            </div>
            <div class="m-6 l-1">
                <img class="margin-bottom" src="{{asset('assets/img/logo-2.png')}}" />
            </div>
            <div class="m-6 l-1">
                <img class="margin-bottom" src="{{asset('assets/img/logo-3.png')}}" />
            </div>
            <div class="m-6 l-1">
                <img class="margin-bottom" src="{{asset('assets/img/logo-1.png')}}" />
            </div>
            <div class="m-6 l-1">
                <img class="margin-bottom" src="{{asset('assets/img/logo-5.png')}}" />
            </div>
            <div class="m-6 l-1">
                <img class="margin-bottom" src="{{asset('assets/img/logo-5.png')}}" />
            </div>
            ...
            <div class="m-6 l-1">
                <img class="margin-bottom" src="{{asset('assets/img/logo-4.png')}}" />
            </div>
            <div class="m-6 l-1">
                <img class="margin-bottom" src="{{asset('assets/img/logo-1.png')}}" />
            </div>
